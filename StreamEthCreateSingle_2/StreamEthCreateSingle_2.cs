...
namespace EthStreamCreateSingle
{
	using System;
	...
	public class Script
	{
		...
		public void Run(IEngine engine)
		{
			...
			command.Source = new Source("BT VB Series - InterAppDemo - Streams - Eth - Create Single");
			...
			var message = new CreateEthStream
			{
				...
				Source = new Source("BT VB Series - InterAppDemo - Streams - Eth - Create Single"),
			};
